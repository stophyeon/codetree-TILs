...
//            }
    ...
    public static boolean check(Golem g){
        return inRange2(g.r,g.c)&&inRange2(g.r+1,g.c)&&inRange2(g.r-1,g.c)&&inRange2(g.r,g.c+1)&&inRange2(g.r,g.c-1);
    }
    ...
    public static boolean inRange2(int r, int c){
        return r>2 && r<=R+2 && c>0 && c<=C;
    }
    public static boolean inRange(int r, int c){
        return r>=0 && r<=R+2 && c>0 && c<=C;
    }
}
